    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='author', to=settings.AUTH_USER_MODEL, verbose_name='作者')),
                ('category', models.ManyToManyField(related_name='category', to='blog.Category', verbose_name='博客分类')),
                ('tags', models.ManyToManyField(related_name='tags', to='blog.Tag', verbose_name='标签')),
            ],
            options={
                'verbose_name': '博客正文',
